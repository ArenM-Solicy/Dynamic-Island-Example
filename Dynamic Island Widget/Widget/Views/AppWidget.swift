...
func expandedBottomView(viewModel: WidgetViewModel) -> some View {
    HStack {
        expandedButtonView(viewModel: viewModel, title: "Signal Up", color: .customGreen, isSignalUp: viewModel.attributes.isSignalUp)
        expandedButtonView(viewModel: viewModel, title: "Signal Down", color: .customRed, isSignalUp: !viewModel.attributes.isSignalUp)
    }
}
